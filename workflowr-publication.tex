...
article, we describe the \textbf{workflowr} interface, explain its design, and
give examples illustrating how \textbf{workflowr} is used in practice.


\section*{Methods}

The \textbf{workflowr} R package makes data analysis projects more organized,
...
step-by-step instructions on starting a \textbf{workflowr} project, see the
