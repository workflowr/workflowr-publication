...
\includegraphics[width=0.8\textwidth]{figures/wflow-fig-1-v02.eps}
...
webpage containing some results; clicking on the ``Home'' hyperlink (2)
in the navigation bar brings the browser back to the main page. For
larger projects, the navigation bar can be used to quickly access
